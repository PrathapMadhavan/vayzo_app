...
function DeliveryPartners() {
  ...
  const filteredPartners = useMemo(() => {
    ...
    return partners.filter((partner) => {
      ...
      return matchesSearch && matchesStatus && matchesVehicle && matchesOnline;
    });
  }, [search, status, vehicleType, onlineStatus, partners]);
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [search, status, vehicleType, onlineStatus]);

  const hasFilters =
    search !== "" ||
    status !== "All Status" ||
    vehicleType !== "All Vehicle Type" ||
    onlineStatus !== "All Online Status" ||false;
            ...
            {loading ? (
              ...
              paginatedPartners.map((partner, index) => (
                ...
                >
                  ...
                  <td className="whitespace-nowrap px-3 py-3 font-medium text-foreground">
                    <div className="max-w-25 sm:max-w-37.5 truncate" title={partner.id}>
                      {partner.id}
                    </div>
                  </td>
                  ...
                  <td className="px-3 py-3">
                    <BadgeCell
                      ...
                      variant={partner.onlineStatus === "Online" ? "success" : "danger"}
                      className="px-3"
                    />
                  </td>
                      ...
                      <ActionMenu
                        actions={[
                          ...
                          },
                          {
                            label: "Edit",
                            icon: Edit,
                            onClick: () => navigate(`/delivery/edit/${partner.id}`),
                          }
                        ]}
                      />
                    </div>
